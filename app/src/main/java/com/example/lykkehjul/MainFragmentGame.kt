...
class MainFragmentGame : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Go to playGameFragment
        val startSpilKnap: Button = view.findViewById(R.id.startSpilKnap)
        startSpilKnap.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_mainFragmentGame_to_playGameFragment)
